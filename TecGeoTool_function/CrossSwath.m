...
%
% 输出：
%   cross_points - n x 7数组，每一行对应提供的线与SWATH的交点部分，
%                  列对应交点的x位置、第一个交点的y位置、第一个交点的最近SWATH距离、 
%                  交叉部分的平均SWATH距离、第二个交点的x位置、第二个交点的y位置，
%                  以及第二个交点的最近SWATH距离。
%
% 示例：
%   [cross_points] = CrossSwath(SW, ln);
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 函数编写者：Adam M. Forte - 更新日期：04/02/19 %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
